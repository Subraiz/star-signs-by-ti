const VideoRecordings = {
  aquarius: [
    {
      track: require("../assets/video/Aquarius 1.mp4"),
    ...
    {
      track: require("../assets/video/Aquarius 2.mp4"),
  ...
  aries: [
    {
      track: require("../assets/video/Aries 1.mp4"),
    ...
    {
      track: require("../assets/video/Aries 2.mp4"),
  ...
  cancer: [
    {
      track: require("../assets/video/Cancer 1.mp4"),
    ...
    {
      track: require("../assets/video/Cancer 2.mp4"),
  ...
  capricorn: [
    {
      track: require("../assets/video/Capricorn 1.mp4"),
    ...
    {
      track: require("../assets/video/Capricorn 2.mp4"),
  ...
  gemini: [
    {
      track: require("../assets/video/Gemini 1.mp4"),
    ...
    {
      track: require("../assets/video/Gemini 2.mp4"),
  ...
  leo: [
    {
      track: require("../assets/video/Leo 1.mp4"),
    ...
    {
      track: require("../assets/video/Leo 2.mp4"),
  ...
  libra: [
    {
      track: require("../assets/video/Libra 1.mp4"),
    ...
    {
      track: require("../assets/video/Libra 2.mp4"),
  ...
  pisces: [
    {
      track: require("../assets/video/Pisces 1.mp4"),
    ...
    {
      track: require("../assets/video/Pisces 2.mp4"),
  ...
  sagittarius: [
    {
      track: require("../assets/video/Sagittarius 1.mp4"),
    ...
    {
      track: require("../assets/video/Sagittarius 2.mp4"),
  ...
  scorpio: [
    {
      track: require("../assets/video/Scorpio 1.mp4"),
    ...
    {
      track: require("../assets/video/Scorpio 2.mp4"),
  ...
  taurus: [
    {
      track: require("../assets/video/Taurus 1.mp4"),
    ...
    {
      track: require("../assets/video/Taurus 2.mp4"),
  ...
  virgo: [
    {
      track: require("../assets/video/Virgo 1.mp4"),
    ...
    {
      track: require("../assets/video/Virgo 2.mp4"),
